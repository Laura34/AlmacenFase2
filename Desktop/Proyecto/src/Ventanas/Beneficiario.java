 ...
 * @author Usuario 1
 */
public class Beneficiario extends javax.swing.JFrame {

    /**
     * Creates new form Beneficiario
     */
    public Beneficiario() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Beneficiario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Beneficiario().setVisible(true);
            }
        });
    }
