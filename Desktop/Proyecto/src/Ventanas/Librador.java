 ...
 * @author Usuario 1
 */
public class Librador extends javax.swing.JFrame {

    /**
     * Creates new form Librador
     */
    public Librador() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Librador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
